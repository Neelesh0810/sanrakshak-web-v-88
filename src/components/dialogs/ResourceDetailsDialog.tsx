  ...
  const resourceData = useMemo(() => {
    ...
    const predefinedResources: Record<string, PredefinedResourceType> = {
      'water-supplies': {
        ...
        quantity: 5000,
        unit: 'bottles',
        location: 'Main Warehouse, Sector 5',
      ...
      'food-supplies': {
        ...
        quantity: 120,
        unit: 'meal kits',
        location: 'Distribution Center, Sector 3',
      ...
      'medical-supplies': {
        ...
        quantity: 350,
        unit: 'kits',
        location: 'Medical Center, Sector 2',
      ...
      'shelter-capacity': {
        ...
        location: 'Multiple Locations (Community Center, School Gymnasium, Church)',
