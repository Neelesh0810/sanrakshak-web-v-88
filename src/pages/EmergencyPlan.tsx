          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-6">
              <div className="bg-black/30 border border-white/10 rounded-xl p-6">
                ...
                <Link to="/alerts" className="flex justify-center w-full mt-4 text-sm bg-white/10 hover:bg-white/15 py-2 rounded-lg transition-colors">
                  View All Alerts
                </Link>
              </div>
              ...
              <div className="bg-black/30 border border-white/10 rounded-xl p-6">
                ...
                <div className="space-y-3">
                  ...
                  <Link to="/map" className="block p-3 bg-white/5 rounded-lg hover:bg-white/10 transition-colors">
                    <p className="text-sm font-medium">Emergency Services Map</p>
                    <p className="text-xs text-gray-400">Locate nearby services</p>
                  </Link>
                  
                  <Link to="#" className="block p-3 bg-white/5 rounded-lg hover:bg-white/10 transition-colors">
